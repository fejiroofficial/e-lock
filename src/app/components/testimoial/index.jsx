...
// Card Component with individual animation
const TestimonialCard = ({ testimonial, animationClass, delay }) => (
  <div
  ...
  return (
    <section className="text-white w-full pt-20 pb-12 px-4 md:px-12 lg:px-20 xl:px-24 2xl:px-40 3xl:px-60">
      <div className="flex items-center justify-center flex-col ">
        <p className="text-xs md:text-sm bg-[#0A0B0D] text-[#F3F3F3] border border-[#444] text-center rounded-md px-3 py-1 inline-block mb-3">
          Testimonials
        </p>
